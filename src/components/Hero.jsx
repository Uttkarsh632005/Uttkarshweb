      ...
      <div className="absolute inset-0 top-[120px] max-w-7xl mx-auto sm:px-16 px-6 flex flex-row items-start gap-5 z-10 pointer-events-none">
        ...
        <div>
          <h1 className="font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2">
            Hi, I'm <span className="text-[#915EFF]">Uttkarsh</span>
          </h1>
          <p className="text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] mt-2 text-white-100">
            I build business-centric <br className="sm:block hidden" />
            Websites and 3D user interfaces.
          </p>
        </div>
      </div>

      {/* 3D Canvas Wala Hissa (Ye important fix hai) */}
